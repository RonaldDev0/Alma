...
export async function updateSession(request: NextRequest) {
  ...
  const publicRoutes = ['/login', '/signup', '/forgot-password', '/auth/confirm', '/auth/callback', '/auth/auth-code-error', '/pricing', '/api/plans', '/api/lemonsqueezy-webhook', '/products', '/api/db', '/list', '/support', '/contact', '/nosotros', '/servicios', '/privacy']

    ...
    <section id='privacy' className='mx-auto pt-24 max-w-4xl px-4 sm:px-6 md:px-8 space-y-8'>
      ...
      <section className='space-y-3'>
        ...
        <ul className='list-disc pl-5 space-y-2 text-sm text-muted-foreground'>
          ...
          <li>
            <strong>Información de pago:</strong> en caso de adquirir productos o
            servicios, podemos recopilar datos necesarios para el pago, como
          ...
          <li>
            <strong>Información de uso:</strong> información sobre tu interacción
            con nuestro sitio web, como las páginas visitadas y las acciones
            realizadas.
          </li>
        </ul>
      </section>
      ...
      <section className='space-y-3'>
        ...
        <ul className='list-disc pl-5 space-y-2 text-sm text-muted-foreground'>
          ...
          <li>
            ...
            cumplir con la ley, hacer valer nuestras políticas o proteger
            nuestros derechos, seguridad o los de terceros.
          </li>
        </ul>
      </section>

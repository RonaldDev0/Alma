...
export default function ForgotPasswordPage() {
  ...
  useEffect(() => {
    if (state.success) {
      toast.success('¡Restablecer correo electrónico enviado! 📧', {
        description: 'Comprueba tu correo electrónico y haz clic en el enlace de restablecimiento para continuar.'
      })
    }
